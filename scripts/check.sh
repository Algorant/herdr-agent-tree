...
bash -n scripts/deploy.sh tests/e2e/sidebar.sh tests/e2e/deploy-reload.sh tests/e2e/mode-cycle.sh
...
if [ "$run_e2e" = true ]; then
    ...
    say 'Isolated Herdr grouped/priority/tree mode-cycle test'
